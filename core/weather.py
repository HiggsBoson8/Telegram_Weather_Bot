...
def weather_city(city):
    try:
        ...
        if city_description['main'] == 'Smoke':
            ...
            city_description_main = f'\U000026C4 {city_description["main"]}'

        elif city_description['main'] == 'Rain':
            city_description_main = f'\U0001F327 {city_description["main"]}'
        ...
        information_weather = f"""Погода в городе: {city_name}
